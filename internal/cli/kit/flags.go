...
var Flags = map[string]Flag{
	...
	"as":                     {Means: "the profile to save an accessed account under"},
	...
	"default":                {Means: "make it the one used when nothing names another"},
	...
	"imap-password-file":     {Means: "where to read another mailbox's password from; - is stdin"},
	"include-inline":         {Means: "include inline attachments"},
	"incoming":               {Means: "act on access others granted you, rather than access you granted"},
	...
	"to":                     {Means: "an address mail goes to: compose sets one, a filter matches one, an import lands on one"},
