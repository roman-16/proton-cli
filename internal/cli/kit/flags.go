...
var Flags = map[string]Flag{
	...
	"category":               {Means: "the kind of abuse a report is about"},
	"cc":                     {Means: "a carbon-copy recipient"},
	"city":                   {Means: "a city"},
	"clear-display-name":     {Means: "remove the name recipients see"},
	...
	"good-faith":             {Means: "declare that what a report says is correct and complete"},
