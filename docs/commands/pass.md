...
It reaches no account and needs no session. The alphabet leaves out i, o, l and their capitals - the characters people misread - unless letters are all the password has.
